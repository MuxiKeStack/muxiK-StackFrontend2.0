...
const Popper: React.FC<{ onClose: () => void }> = memo(({ onClose }) => {
  ...
  return (
    <View className="popper_mask">
      <View className="popper_container">
        <View className="popper_header">
          <Text className="popper_title">木犀课栈隐私条例</Text>
          {/* <Text className="popper_close" onClick={onClose}>
            ×
          </Text> */}
        </View>
        ...
        >
          <View className="popper_content_inner">
            <p>
            ...
            <h3 className="popper_section_title">我们收集的信息</h3>

            <p>
              我们根据合法、正当、必要的原则，仅收集实现产品功能所必要的信息，并将竭力通过有效的信息安全技术及管理流程，防止您的信息泄露、损毁、丢失。
            </p>

            <h4 className="popper_subtitle">1. 您在使用我们服务时主动提供的信息</h4>
            ...
            <h4 className="popper_subtitle">2. 我们在您使用服务时获取的信息</h4>
            <p>
              当您使用我们的服务时，我们可能会存储服务日志信息。例如搜索、查看的信息、服务故障信息等。
            </p>

            <h4 className="popper_subtitle">3. 其他相关信息</h4>
            <ul className="popper_list">
              <li>
            ...
            <h3 className="popper_section_title">我们如何使用收集的信息</h3>
            <ul className="popper_list">
              <li>向您提供服务。</li>
              <li>产品开发和服务优化。</li>
            ...
            <h3 className="popper_section_title">您分享的信息</h3>
            <p>
              您可以通过我们的服务与好友分享相关课程或评价信息。请注意，这其中可能包含您的个人身份信息，请谨慎考虑披露。
            </p>

            <h3 className="popper_section_title">联系我们</h3>
            <p>如您对本条例或其他相关事宜有疑问，请通过QQ群：764752182与我们联系</p>
          </View>
        </ScrollView>

        <View className="popper_footer">
          <View
            className={`popper_btn ${!isAtBottom ? 'popper_btn_disabled' : ''}`}
            onClick={handleAgree}
          >
            我已阅读完毕
          </View>
