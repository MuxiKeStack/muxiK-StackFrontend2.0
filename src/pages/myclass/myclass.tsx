import { View,Picker,Text,Input,Image,PickerView} from '@tarojs/components'
...
export default function Myclass() {
    ...
    const [yearSelector,setYearSelector] = useState(['2022-2023学年','2023-2024学年','2024-2025学年','2025-2026学年'])
    ...
    const [myclasses,setMyclasses] = useState([{name:'人体解剖学 （成良）',status:false},{name:'人体解剖学 （成良）',status:false},{name:'人体解剖学 （成良）',status:false},{name:'人体解剖学 （成良）',status:false},{name:'人体解剖学 （成良）',status:false}])
    ...
    <View>
        ...
        <View className='classes'>
            {
                myclasses.map((each)=>{
                    return <View className='eachClass'>
                        <View></View>
