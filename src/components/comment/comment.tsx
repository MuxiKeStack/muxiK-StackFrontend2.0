    ...
    <View className='bigcomment'>
        <View className='comment'>
            ...
            <View className='p'>
                ...
                <View className='time'>{props.date} {props.time}</View>
            </View>
         <View className='p'>
                <View className='stars'>
                    <ShowStar score={props.score}></ShowStar>
                </View>
                <Image style={`display:${props.isHot?'block':'none'}`} className='fire' src='https://s2.loli.net/2023/11/12/2ITKRcDPMZaQCvk.png'>
                </Image>
        </View>
